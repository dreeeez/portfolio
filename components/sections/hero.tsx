  ...
  return (
    <div className="relative">
      ...
      <div className="relative rounded-full bg-gradient-to-br from-white/50 via-white/10 to-transparent p-[1.5px] shadow-[0_18px_40px_-12px_rgba(0,0,0,0.5)] dark:from-white/25 dark:via-white/5">
        <div className="relative h-36 w-36 overflow-hidden rounded-full border border-border/40 bg-card/40 backdrop-blur-sm sm:h-40 sm:w-40 md:h-44 md:w-44 lg:h-52 lg:w-52 xl:h-60 xl:w-60 2xl:h-72 2xl:w-72">
          <Image
            ...
            sizes="(min-width: 1536px) 18rem, (min-width: 1280px) 15rem, (min-width: 1024px) 13rem, (min-width: 768px) 11rem, (min-width: 640px) 10rem, 9rem"
