...
export const projects: Project[] = [
  ...
  {
    slug: "ecorize-messe-flyer-front",
    category: "graphics",
    title: "Hannover Messe Flyer — Front",
    description: {
      en: "Trade-fair flyer designed in InDesign for ecorize at Hannover Messe — front side with a bold headline, clear messaging and on-brand visual language.",
      de: "Messe-Flyer, in InDesign für ecorize zur Hannover Messe gestaltet — Vorderseite mit kräftiger Headline, klarer Botschaft und markenkonformer Bildsprache.",
    },
  ...
  },
  {
    ...
    category: "graphics",
    title: "Hannover Messe Flyer — Back",
    description: {
      en: "Trade-fair flyer designed in InDesign for ecorize at Hannover Messe — back side with supporting content, structured layout and consistent typography.",
      de: "Messe-Flyer, in InDesign für ecorize zur Hannover Messe gestaltet — Rückseite mit ergänzenden Inhalten, strukturiertem Layout und konsistenter Typografie.",
    },
    tags: ["InDesign", "Flyer", "Hannover Messe"],
    year: "2025",
  ...
  },
  {
    ...
    title: "VBS Poster",
    description: {
      en: "Poster designed in Figma — a hand-built, low-poly illustration of a fjord-side campus crowned by an oversized 'VBS' wordmark.",
      de: "Poster, in Figma gestaltet — eine handgebaute Low-Poly-Illustration eines Campus am Fjord, gekrönt von einem überdimensionalen 'VBS'-Schriftzug.",
    },
    tags: ["Figma", "Poster", "Illustration"],
    year: "2025",
    image: "/graphics/vbs-poster.png",
    subpage: true,
    subpagePath: "/projects/graphics",
  },
  {
    slug: "brunstad-history-poster",
    category: "graphics",
    title: "Brunstad History Poster",
    description: {
      en: "Poster designed in Figma — a low-poly montage from 1956 to today, layering historic and modern scenes of the same site into one timeline.",
      de: "Poster, in Figma gestaltet — eine Low-Poly-Montage von 1956 bis heute, die historische und moderne Szenen desselben Orts zu einer Zeitachse schichtet.",
    },
    tags: ["Figma", "Poster", "Illustration"],
    year: "2025",
    image: "/graphics/brunstad-history-poster.png",
    subpage: true,
    subpagePath: "/projects/graphics",
  },
  {
    slug: "samvirk-poster",
    category: "graphics",
    title: "Samvirk Poster",
    description: {
      en: "Poster designed in Figma — a bold comic-style scene with halftone pop-art shading and a 'Hey, that's my suite!' speech burst.",
      de: "Poster, in Figma gestaltet — eine kräftige Comic-Szene mit Halbton-Pop-Art-Schattierung und einem 'Hey, that's my suite!'-Sprechblasen-Knall.",
    },
    tags: ["Figma", "Poster", "Comic"],
    year: "2025",
    image: "/graphics/samvirk-poster.png",
    subpage: true,
    subpagePath: "/projects/graphics",
  },
];
