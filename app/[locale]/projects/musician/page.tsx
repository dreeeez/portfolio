...
const project = projects.find((p) => p.slug === "musician");

export const metadata: Metadata = {
  title: project?.title ?? "Musician — Short",
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 max-w-2xl space-y-4 text-base leading-7">
          <p className="text-foreground/85">
            {loc === "de"
              ? "Für unsere Weihnachtsfeier haben wir ein Video produziert, bei dem es darum ging, das passende Moderations-Duo zu finden — hier die Audition-Version mit zwei Musikern."
              : "For our Christmas party we shot a video about finding the right hosting duo — this is the audition take with two musicians."}
          </p>
