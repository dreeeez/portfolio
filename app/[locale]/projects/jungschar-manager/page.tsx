        ...
        <div className="mt-8 max-w-2xl space-y-10 text-base leading-7">
          <section className="space-y-3">
            ...
            <p className="text-foreground/85">
              {loc === "de"
                ? "Die wöchentliche Jungschar lebt von Koordination: Wer leitet, wer kocht, wer kommt überhaupt? Vorher lief das über WhatsApp — mit dem Ergebnis, dass Nachrichten untergingen, Termine vergessen wurden und am Freitagabend noch hektisch geklärt werden musste, ob das Essen organisiert ist. Der Bot übernimmt diese wiederkehrenden Abstimmungen vollständig: Reminder kommen pünktlich, Zu- und Absagen sind sichtbar, Geburtstage und Wetter sind automatisch dabei. Das Leitungsteam muss nichts mehr im Kopf behalten — die Standardprozesse laufen von selbst."
                : "The weekly youth group runs on coordination: who's leading, who's cooking, who's even showing up? Before, all of that lived in WhatsApp — messages got buried, dates were forgotten, and Friday evening was still spent hectically figuring out whether dinner was sorted. The bot takes over these recurring agreements completely: reminders arrive on time, RSVPs are visible, birthdays and weather show up automatically. The leadership team doesn't have to keep anything in their head anymore — the standard processes run on their own."}
            </p>
          </section>
